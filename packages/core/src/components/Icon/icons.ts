/**
 * Icon library - Heroicons-inspired SVG paths
 */
...
export const icons = {
  ...
  alert: '<path d="M12 9v3m0 3h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/>',
  ...
  'menu-alt': '<path d="M4 8h16M4 16h16"/>',
  ...
  stop: '<rect x="5" y="5" width="14" height="14" rx="2" ry="2"/>',
  ...
  layout: '<rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><path d="M3 9h18M9 21V9"/>',
